...
const ProductCollection = ({ collection }) => {
  ...
  // Add function to fetch purchase history for all products in collection
  const fetchPurchaseHistory = async () => {
    ...
    try {
      // Get product names for all products in this collection
  ...
  return (
    <Card sx={{ mb: 2 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <Box>
              <Tooltip title="View Purchase History">
                <IconButton size="small" onClick={handleOpenPurchaseHistory} sx={{ mr: 1 }}>
      ...
      >
        <DialogTitle>
          Purchase History - {collection.name}
        </DialogTitle>
        <DialogContent>
          {loadingPurchases ? (
            ...
            <Typography variant="body1" sx={{ textAlign: 'center', my: 3 }}>
              No purchase history found for products in this collection.
            </Typography>
          ) : (
