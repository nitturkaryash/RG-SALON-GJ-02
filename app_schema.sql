...
DROP POLICY stock_history_policy ON public.stock_history;
DROP POLICY sales_select_policy ON public.sales;
DROP POLICY "public select membership_tiers" ON public.membership_tiers;
DROP POLICY allow_public_select_inventory_salon_consumption ON public.inventory_salon_consumption;
DROP POLICY "Enable update for authenticated users only" ON public.service_collections;
DROP POLICY "Enable update for authenticated users" ON public.stylist_holidays;
DROP POLICY "Enable read access for all users" ON public.stylist_holidays;
DROP POLICY "Enable read access for all users" ON public.service_collections;
DROP POLICY "Enable insert for authenticated users only" ON public.service_collections;
DROP POLICY "Enable insert for authenticated users" ON public.stylist_holidays;
DROP POLICY "Enable delete for authenticated users only" ON public.service_collections;
DROP POLICY "Enable delete for authenticated users" ON public.stylist_holidays;
DROP POLICY "Allow update for authenticated users" ON public.membership_tiers;
DROP POLICY "Allow read access for all authenticated users" ON public.membership_tiers;
DROP POLICY "Allow public update membership_tiers" ON public.membership_tiers;
DROP POLICY "Allow public delete membership_tiers" ON public.membership_tiers;
DROP POLICY "Allow insert for authenticated users" ON public.membership_tiers;
DROP POLICY "Allow full access" ON public.stock_history;
DROP POLICY "Allow delete for authenticated users" ON public.membership_tiers;
DROP POLICY "Allow authenticated users full access" ON public.inventory_salon_consumption;
DROP POLICY "Allow all inserts to sales" ON public.sales;
ALTER TABLE ONLY public.stylist_holidays DROP CONSTRAINT stylist_holidays_stylist_id_fkey;
ALTER TABLE ONLY public.stylist_breaks DROP CONSTRAINT stylist_breaks_stylist_id_fkey;
ALTER TABLE ONLY public.services DROP CONSTRAINT services_subcollection_id_fkey;
ALTER TABLE ONLY public.service_subcollections DROP CONSTRAINT service_subcollections_collection_id_fkey;
ALTER TABLE ONLY public.sales DROP CONSTRAINT sales_stylist_id_fkey;
ALTER TABLE ONLY public.sales DROP CONSTRAINT sales_product_id_fkey;
ALTER TABLE ONLY public.sales DROP CONSTRAINT sales_customer_id_fkey;
ALTER TABLE ONLY public.purchases DROP CONSTRAINT purchases_product_id_fkey;
ALTER TABLE ONLY public.purchase_stock DROP CONSTRAINT purchase_stock_stock_id_fkey;
ALTER TABLE ONLY public.product_stock_transactions DROP CONSTRAINT product_stock_transactions_product_id_fkey;
ALTER TABLE ONLY public.product_stock_transactions DROP CONSTRAINT product_stock_transactions_order_id_fkey;
ALTER TABLE ONLY public.product_stock_transactions DROP CONSTRAINT product_stock_transactions_created_by_fkey;
ALTER TABLE ONLY public.pos_order_items DROP CONSTRAINT pos_order_items_pos_order_id_fkey;
ALTER TABLE ONLY public.order_stylists DROP CONSTRAINT order_stylists_stylist_id_fkey;
ALTER TABLE ONLY public.order_stylists DROP CONSTRAINT order_stylists_order_id_fkey;
ALTER TABLE ONLY public.notification_logs DROP CONSTRAINT notification_logs_old_appointment_id_fkey;
ALTER TABLE ONLY public.notification_logs DROP CONSTRAINT notification_logs_appointment_id_fkey;
ALTER TABLE ONLY public.members DROP CONSTRAINT members_tier_id_fkey;
ALTER TABLE ONLY public.members DROP CONSTRAINT members_client_id_fkey;
ALTER TABLE ONLY public.loyalty_points DROP CONSTRAINT loyalty_points_client_id_fkey;
ALTER TABLE ONLY public.services DROP CONSTRAINT fk_service_collection;
ALTER TABLE ONLY public.inventory_salon_consumption DROP CONSTRAINT fk_salon_consumption_product_master;
ALTER TABLE ONLY public.sales DROP CONSTRAINT fk_sales_consumption;
ALTER TABLE ONLY public.inventory_purchases DROP CONSTRAINT fk_product_master;
ALTER TABLE ONLY public.product_master DROP CONSTRAINT fk_product_collection;
ALTER TABLE ONLY public.consumption DROP CONSTRAINT fk_consumption_sale;
ALTER TABLE ONLY public.consumption DROP CONSTRAINT consumption_product_id_fkey;
ALTER TABLE ONLY public.breaks DROP CONSTRAINT breaks_stylist_id_fkey;
ALTER TABLE ONLY public.balance_stock DROP CONSTRAINT balance_stock_stock_id_fkey;
ALTER TABLE ONLY public.appointments DROP CONSTRAINT appointments_stylist_id_fkey;
ALTER TABLE ONLY public.appointments DROP CONSTRAINT appointments_service_id_fkey;
ALTER TABLE ONLY public.appointments DROP CONSTRAINT appointments_client_id_fkey;
ALTER TABLE ONLY public.appointment_stylists DROP CONSTRAINT appointment_stylists_stylist_id_fkey;
ALTER TABLE ONLY public.appointment_stylists DROP CONSTRAINT appointment_stylists_client_id_fkey;
ALTER TABLE ONLY public.appointment_stylists DROP CONSTRAINT appointment_stylists_appointment_id_fkey;
ALTER TABLE ONLY public.appointment_services DROP CONSTRAINT appointment_services_stylist_id_fkey;
ALTER TABLE ONLY public.appointment_services DROP CONSTRAINT appointment_services_service_id_fkey;
ALTER TABLE ONLY public.appointment_services DROP CONSTRAINT appointment_services_client_id_fkey;
ALTER TABLE ONLY public.appointment_services DROP CONSTRAINT appointment_services_appointment_id_fkey;
ALTER TABLE ONLY public.appointment_clients DROP CONSTRAINT appointment_clients_client_id_fkey;
ALTER TABLE ONLY public.appointment_clients DROP CONSTRAINT appointment_clients_appointment_id_fkey;
DROP TRIGGER update_notification_logs_timestamp ON public.notification_logs;
DROP TRIGGER trig_avoid_multiple_product_order_entries ON public.product_stock_transactions;
DROP TRIGGER trig_avoid_duplicate_insert ON public.product_stock_transactions;
DROP TRIGGER trg_update_stock_on_purchase ON public.purchases;
DROP TRIGGER trg_update_purchase_cost_on_product_master ON public.purchase_history_with_stock;
DROP TRIGGER trg_update_product_stock_on_sale ON public.sales;
DROP TRIGGER trg_update_balance_stock_on_purchase ON public.purchase_stock;
DROP TRIGGER trg_sales_update_stock ON public.sales;
DROP TRIGGER trg_reduce_stock_on_salon_consumption ON public.pos_orders;
DROP TRIGGER trg_reduce_stock_after_purchase_delete ON public.purchase_history_with_stock;
DROP TRIGGER trg_purchases_update_stock ON public.purchases;
DROP TRIGGER trg_log_stock_reduction ON public.product_master;
DROP TRIGGER trg_log_stock_increase ON public.product_master;
DROP TRIGGER trg_freeze_remaining_stock ON public.sales_product_data;
DROP TRIGGER trg_delete_purchase_history ON public.product_master;
DROP TRIGGER trg_consumption_update_stock ON public.consumption;
DROP TRIGGER set_timestamp_membership_tiers ON public.membership_tiers;
DROP TRIGGER set_timestamp_members ON public.members;
DROP TRIGGER restore_stock_on_order_item_delete_trigger ON public.pos_order_items;
DROP TRIGGER restore_pos_orders_trigger ON public.pos_orders;
DROP TRIGGER record_stock_on_product_insert_trigger ON public.product_master;
DROP TRIGGER purchases_stock_update ON public.purchases;
DROP TRIGGER process_pos_order_with_duplicates_trigger ON public.pos_orders;
DROP TRIGGER new_inventory_trigger ON public.balance_stock_data;
DROP TRIGGER inventory_change_trigger ON public.balance_stock_data;
DROP TRIGGER after_sales_insert ON public.sales;
DROP TRIGGER after_purchase_insert ON public.purchases;
DROP TRIGGER after_insert_stock_transaction ON public.product_stock_transactions;
DROP TRIGGER after_balance_stock_update ON public.balance_stock;
DROP INDEX public.idx_unique_duplicate_key;
DROP INDEX public.idx_stylist_holidays_stylist_id;
DROP INDEX public.idx_stylist_holidays_date;
DROP INDEX public.idx_stylist_breaks_stylist_id;
DROP INDEX public.idx_stylist_breaks_start_time;
DROP INDEX public.idx_stock_snapshots_product_id;
DROP INDEX public.idx_stock_snapshots_order_type;
DROP INDEX public.idx_stock_snapshots_order_date;
DROP INDEX public.idx_stock_reductions_reference_id;
DROP INDEX public.idx_stock_reductions_product_name;
DROP INDEX public.idx_stock_reductions_date;
DROP INDEX public.idx_stock_history_source;
DROP INDEX public.idx_stock_history_product_name;
DROP INDEX public.idx_stock_history_product_id;
DROP INDEX public.idx_stock_history_date;
DROP INDEX public.idx_stock_history_change_type;
DROP INDEX public.idx_services_category;
DROP INDEX public.idx_services_active;
DROP INDEX public.idx_service_subcollections_collection_id;
DROP INDEX public.idx_service_collections_name;
DROP INDEX public.idx_sales_stylist_id;
DROP INDEX public.idx_sales_salon_consumption;
DROP INDEX public.idx_sales_product_id;
DROP INDEX public.idx_sales_customer_id;
DROP INDEX public.idx_sales_created_at;
DROP INDEX public.idx_purchases_product_id;
DROP INDEX public.idx_purchase_history_transaction_type;
DROP INDEX public.idx_products_name;
DROP INDEX public.idx_products_active;
DROP INDEX public.idx_product_stock_transactions_product_id;
DROP INDEX public.idx_product_stock_transactions_order_id;
DROP INDEX public.idx_product_stock_transactions_created_at;
DROP INDEX public.idx_pos_orders_status;
DROP INDEX public.idx_pos_orders_customer_name;
DROP INDEX public.idx_pos_orders_created_at;
DROP INDEX public.idx_pos_orders_client_name;
DROP INDEX public.idx_pos_order_items_order_id;
DROP INDEX public.idx_notification_logs_sent_at;
DROP INDEX public.idx_notification_logs_appointment_id;
DROP INDEX public.idx_members_tier_id;
DROP INDEX public.idx_members_expiry;
DROP INDEX public.idx_members_client_id;
DROP INDEX public.idx_inventory_purchases_transaction_type;
DROP INDEX public.idx_duplicate_protection;
DROP INDEX public.idx_consumption_product_id;
DROP INDEX public.idx_breaks_stylist_id;
DROP INDEX public.idx_breaks_start_time;
DROP INDEX public.idx_balance_stock_history_product;
DROP INDEX public.idx_balance_stock_history_date;
DROP INDEX public.idx_balance_stock_data_product_name;
DROP INDEX public.idx_appointments_stylist_id;
DROP INDEX public.idx_appointments_status;
DROP INDEX public.idx_appointments_start_time;
DROP INDEX public.idx_appointments_reminder_2h;
DROP INDEX public.idx_appointments_reminder_24h;
DROP INDEX public.idx_appointments_reminder;
DROP INDEX public.idx_appointments_paid;
DROP INDEX public.idx_appointments_client_id;
DROP INDEX public.idx_appointments_checked_in;
DROP INDEX public.idx_appointment_stylists_stylist_id;
DROP INDEX public.idx_appointment_stylists_is_primary;
DROP INDEX public.idx_appointment_stylists_appointment_id;
DROP INDEX public.idx_appointment_clients_client_id;
DROP INDEX public.idx_appointment_clients_appointment_id;
ALTER TABLE ONLY public.trigger_debug_log DROP CONSTRAINT trigger_debug_log_pkey;
ALTER TABLE ONLY public.stylists DROP CONSTRAINT stylists_pkey;
ALTER TABLE ONLY public.stylist_holidays DROP CONSTRAINT stylist_holidays_pkey;
ALTER TABLE ONLY public.stylist_breaks DROP CONSTRAINT stylist_breaks_pkey;
ALTER TABLE ONLY public.stock_snapshots DROP CONSTRAINT stock_snapshots_sale_order_id_product_id_key;
ALTER TABLE ONLY public.stock_snapshots DROP CONSTRAINT stock_snapshots_pkey;
ALTER TABLE ONLY public.stock_reductions DROP CONSTRAINT stock_reductions_pkey;
ALTER TABLE ONLY public.stock_history DROP CONSTRAINT stock_history_pkey;
ALTER TABLE ONLY public.stock_details DROP CONSTRAINT stock_details_pkey;
ALTER TABLE ONLY public.stock_deduction_debug_log DROP CONSTRAINT stock_deduction_debug_log_pkey;
ALTER TABLE ONLY public.services DROP CONSTRAINT services_pkey;
ALTER TABLE ONLY public.service_subcollections DROP CONSTRAINT service_subcollections_pkey;
ALTER TABLE ONLY public.service_collections DROP CONSTRAINT service_collections_pkey;
ALTER TABLE ONLY public.sales_product_table DROP CONSTRAINT sales_product_table_pkey;
ALTER TABLE ONLY public.sales_product_new_table DROP CONSTRAINT sales_product_new_table_pkey;
ALTER TABLE ONLY public.sales_product_data DROP CONSTRAINT sales_product_data_pkey;
ALTER TABLE ONLY public.sales DROP CONSTRAINT sales_pkey;
ALTER TABLE ONLY public.purchases DROP CONSTRAINT purchases_pkey;
ALTER TABLE ONLY public.purchase_stock DROP CONSTRAINT purchase_stock_purchase_invoice_no_key;
ALTER TABLE ONLY public.purchase_stock DROP CONSTRAINT purchase_stock_pkey;
ALTER TABLE ONLY public.purchase_history_with_stock DROP CONSTRAINT purchase_history_with_stock_pkey;
ALTER TABLE ONLY public.product_master DROP CONSTRAINT products_pkey;
ALTER TABLE ONLY public.product_stock_transactions DROP CONSTRAINT product_stock_transactions_pkey;
ALTER TABLE ONLY public.product_stock_transactions DROP CONSTRAINT product_stock_transactions_duplicate_protection_key_key;
ALTER TABLE ONLY public.product_collections DROP CONSTRAINT product_collections_pkey;
ALTER TABLE ONLY public.pos_orders DROP CONSTRAINT pos_orders_pkey;
ALTER TABLE ONLY public.pos_order_items DROP CONSTRAINT pos_order_items_pkey;
ALTER TABLE ONLY public.order_stylists DROP CONSTRAINT order_stylists_pkey;
ALTER TABLE ONLY public.notification_logs DROP CONSTRAINT notification_logs_pkey;
...
ALTER TABLE ONLY public.membership_tiers DROP CONSTRAINT membership_tiers_pkey;
...
ALTER TABLE ONLY public.inventory_salon_consumption DROP CONSTRAINT inventory_salon_consumption_pkey;
ALTER TABLE ONLY public.inventory_sales_new DROP CONSTRAINT inventory_sales_new_pkey;
ALTER TABLE ONLY public.inventory_purchases DROP CONSTRAINT inventory_purchases_pkey;
ALTER TABLE ONLY public.inventory_consumption DROP CONSTRAINT inventory_consumption_pkey;
ALTER TABLE ONLY public.expired_products DROP CONSTRAINT expired_products_pkey;
ALTER TABLE ONLY public.customers DROP CONSTRAINT customers_pkey;
ALTER TABLE ONLY public.consumption DROP CONSTRAINT consumption_pkey;
ALTER TABLE ONLY public.clients DROP CONSTRAINT clients_pkey;
ALTER TABLE ONLY public.breaks DROP CONSTRAINT breaks_pkey;
ALTER TABLE ONLY public.balance_stock_transactions DROP CONSTRAINT balance_stock_transactions_pkey;
ALTER TABLE ONLY public.balance_stock DROP CONSTRAINT balance_stock_stock_id_key;
ALTER TABLE ONLY public.balance_stock DROP CONSTRAINT balance_stock_pkey;
ALTER TABLE ONLY public.balance_stock_history DROP CONSTRAINT balance_stock_history_pkey;
ALTER TABLE ONLY public.balance_stock_data DROP CONSTRAINT balance_stock_data_pkey;
...
ALTER TABLE ONLY public.appointment_stylists DROP CONSTRAINT appointment_stylists_pkey;
ALTER TABLE ONLY public.appointment_stylists DROP CONSTRAINT appointment_stylists_appointment_id_stylist_id_key;
ALTER TABLE ONLY public.appointment_services DROP CONSTRAINT appointment_services_pkey;
ALTER TABLE ONLY public.appointment_services DROP CONSTRAINT appointment_services_id_key;
ALTER TABLE ONLY public.appointment_clients DROP CONSTRAINT appointment_clients_pkey;
...
ALTER TABLE public.trigger_debug_log ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.stock_details ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.stock_deduction_debug_log ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.purchase_stock ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.migrations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.balance_stock ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.admin_users ALTER COLUMN id DROP DEFAULT;
DROP VIEW public.vw_stock_transactions;
DROP VIEW public.vw_purchase_recalc;
DROP SEQUENCE public.trigger_debug_log_id_seq;
DROP TABLE public.trigger_debug_log;
DROP TABLE public.stylists;
DROP TABLE public.stylist_holidays;
DROP TABLE public.stylist_breaks;
DROP TABLE public.stock_reductions;
DROP VIEW public.stock_history_view;
DROP TABLE public.stock_history;
DROP SEQUENCE public.stock_details_id_seq;
DROP TABLE public.stock_details;
DROP SEQUENCE public.stock_deduction_debug_log_id_seq;
DROP TABLE public.stock_deduction_debug_log;
DROP TABLE public.services;
DROP TABLE public.service_subcollections;
DROP TABLE public.service_collections;
DROP VIEW public.salon_stock_tracking;
DROP VIEW public.salon_consumption_view;
DROP VIEW public.salon_consumption_stock_views;
DROP VIEW public.salon_consumption_stock_viewh;
DROP VIEW public.salon_consumption_products;
DROP VIEW public.salon_consumption_new;
DROP VIEW public.salon_consumption_history;
DROP VIEW public.salon_consumption_final;
DROP TABLE public.sales_product_table;
DROP VIEW public.sales_product_stock_view;
DROP TABLE public.sales_product_new_table;
DROP VIEW public.sales_product_new_final_s;
DROP VIEW public.sales_product_new;
DROP TABLE public.stock_snapshots;
DROP TABLE public.sales_product_data;
DROP VIEW public.sales_history_grouped;
DROP VIEW public.sales_history_fl;
DROP VIEW public.sales_history_final_test3;
DROP VIEW public.sales_history_final_test2;
DROP VIEW public.sales_history_final_test;
DROP VIEW public.sales_history_final_tes;
DROP VIEW public.sales_history_final_new_final;
DROP VIEW public.sales_history_final_2;
DROP VIEW public.sales_history_final;
DROP VIEW public.sales_history_fin;
DROP VIEW public.sale_stock_view_new;
DROP VIEW public.sale_stock_view;
DROP VIEW public.sale_product_vieww;
DROP SEQUENCE public.purchase_stock_id_seq;
DROP TABLE public.purchase_stock;
DROP TABLE public.purchase_history_with_stock;
DROP VIEW public.product_stock_status;
DROP VIEW public.product_inventory_summary;
DROP TABLE public.sales;
DROP TABLE public.purchases;
DROP TABLE public.product_collections;
DROP VIEW public.pos_product_sales_with_stoc;
DROP TABLE public.pos_order_items;
DROP TABLE public.order_stylists;
...
DROP VIEW public.inventory_transaction_view;
DROP VIEW public.inventory_transaction_history;
DROP TABLE public.inventory_transactions;
DROP TABLE public.inventory_salon_consumption;
DROP TABLE public.inventory_sales_new;
DROP TABLE public.inventory_purchases;
DROP TABLE public.inventory_consumption;
DROP VIEW public.g;
DROP TABLE public.expired_products;
DROP TABLE public.customers;
DROP TABLE public.consumption;
DROP TABLE public.clients;
DROP TABLE public.breaks;
DROP VIEW public.balance_stock_view;
DROP VIEW public.products;
DROP TABLE public.balance_stock_transactions;
DROP SEQUENCE public.balance_stock_id_seq;
DROP TABLE public.balance_stock_history;
DROP TABLE public.balance_stock_data;
DROP TABLE public.balance_stock;
DROP TABLE public.auth;
DROP TABLE public.appointments;
DROP TABLE public.appointment_stylists;
DROP TABLE public.appointment_services;
DROP TABLE public.appointment_clients;
DROP SEQUENCE public.admin_users_id_seq;
DROP FUNCTION public.verify_stock_recording(product_id uuid);
DROP FUNCTION public.update_updated_at_column();
DROP FUNCTION public.update_stylists_on_holiday();
DROP FUNCTION public.update_stylist_availability_on_holiday_change();
DROP FUNCTION public.update_stock_transaction_history();
DROP FUNCTION public.update_stock_on_purchase();
DROP FUNCTION public.update_sales_history_product_name();
DROP FUNCTION public.update_product_stock_on_sale();
DROP FUNCTION public.update_product_stock_after_consumption();
DROP FUNCTION public.update_product_master_purchase_cost();
DROP FUNCTION public.update_notification_logs_updated_at();
DROP FUNCTION public.update_balance_stock_on_purchase();
DROP FUNCTION public.update_balance_stock_on_orders();
DROP FUNCTION public.update_balance_stock_data();
DROP FUNCTION public.update_balance_stock();
DROP FUNCTION public.trigger_sync_salon_consumption();
DROP FUNCTION public.trigger_set_timestamp();
DROP FUNCTION public.sync_total_amounts();
DROP FUNCTION public.sync_service_prices();
DROP FUNCTION public.sync_sales_product_table();
DROP FUNCTION public.sync_product_to_inventory();
DROP FUNCTION public.sync_pos_salon_consumption();
DROP FUNCTION public.sync_customer_names();
DROP FUNCTION public.sales_product_new_update();
DROP FUNCTION public.sales_product_new_instead_of_update();
DROP FUNCTION public.sales_product_new_insert();
DROP FUNCTION public.sales_product_new_delete();
DROP FUNCTION public.safe_create_order(order_data jsonb);
DROP FUNCTION public.restore_stock_on_order_item_delete();
DROP FUNCTION public.restore_pos_orders();
DROP FUNCTION public.reset_stylists_not_on_holiday();
DROP FUNCTION public.remove_stylist_holiday(p_holiday_id uuid);
DROP FUNCTION public.reduce_stock_on_purchase_delete();
DROP FUNCTION public.reduce_balance_stock_on_order();
DROP FUNCTION public.record_stock_transactions_after_order();
DROP FUNCTION public.record_purchase_stock_change();
DROP FUNCTION public.record_product_stock_transaction();
DROP FUNCTION public.record_product_stock_on_insert();
DROP FUNCTION public.record_pos_order_stock_change_debug();
DROP FUNCTION public.record_pos_order_stock_change();
DROP FUNCTION public.record_order_item_stock_change();
DROP FUNCTION public.record_inventory_transaction(p_product_name text, p_hsn_code text, p_units text, p_change_type text, p_quantity_change numeric, p_current_balance numeric, p_source text, p_reference_id text);
DROP FUNCTION public.process_pos_order_with_duplicates();
DROP FUNCTION public.prevent_remaining_stock_update();
DROP FUNCTION public.order_has_products(order_data jsonb);
DROP FUNCTION public.monitor_product_stock_transaction();
DROP FUNCTION public.log_stock_reduction();
DROP FUNCTION public.log_stock_increase();
DROP FUNCTION public.log_stock_change_from_product_master();
DROP FUNCTION public.log_sales_reduction();
DROP FUNCTION public.log_remaining_stock_changes();
DROP FUNCTION public.log_purchase_addition();
DROP FUNCTION public.log_new_inventory();
DROP FUNCTION public.log_inventory_change();
DROP FUNCTION public.log_balance_stock_reduction();
DROP FUNCTION public.is_stylist_on_holiday(p_stylist_id uuid, p_date date);
DROP FUNCTION public.insert_stock_snapshot();
DROP FUNCTION public.insert_salon_consumption_snapshot();
DROP FUNCTION public.insert_sales_product_data(p_serial_no text, p_order_id uuid, p_date date, p_product_name text, p_quantity integer, p_unit_price_ex_gst numeric, p_gst_percentage numeric, p_discount numeric, p_tax numeric, p_hsn_code text, p_product_type text, p_mrp_incl_gst numeric, p_discounted_sales_rate_ex_gst numeric, p_current_stock integer, p_total_sold integer);
DROP FUNCTION public.increment_product_stock(p_product_id uuid, p_increment_quantity integer);
DROP FUNCTION public.increment_product_stock(product_updates jsonb[]);
DROP FUNCTION public.handle_updated_at();
DROP FUNCTION public.handle_order_deletion_update_client_spent();
DROP FUNCTION public.handle_new_user();
DROP FUNCTION public.get_transaction_display();
DROP FUNCTION public.get_table_columns(table_name text);
DROP FUNCTION public.get_stylist_holidays(p_stylist_id uuid);
DROP FUNCTION public.get_stock_transactions(p_limit integer, p_offset integer, p_date_from timestamp with time zone, p_date_to timestamp with time zone, p_product_id uuid, p_transaction_type character varying);
DROP FUNCTION public.get_product_transaction_history(p_product_id uuid);
DROP FUNCTION public.get_next_balance_stock_serial();
DROP FUNCTION public.get_balance_stock();
DROP VIEW public.product_stock_transaction_history;
DROP TABLE public.product_stock_transactions;
DROP TABLE public.product_master;
DROP TABLE public.pos_orders;
DROP FUNCTION public.generate_salon_consumption_serial();
DROP FUNCTION public.freeze_remaining_stock_on_update();
DROP FUNCTION public.fn_insert_purchase_history_stock();
DROP FUNCTION public.exec_sql(sql text);
DROP FUNCTION public.ensure_inventory_sales_product_name();
DROP FUNCTION public.delete_sales_item(item_id text);
DROP FUNCTION public.delete_purchase_history_on_product_delete();
DROP FUNCTION public.decrement_product_stock_compat(product_updates jsonb);
DROP FUNCTION public.decrement_product_stock(product_updates jsonb[]);
DROP FUNCTION public.create_stylist_holidays_table();
DROP FUNCTION public.clean_duplicate_transactions();
DROP FUNCTION public.check_debug_logs(order_id text);
DROP FUNCTION public.check_appointment_conflict();
DROP FUNCTION public.check_admin_login(email_input text, password_input text);
DROP TABLE public.admin_users;
DROP FUNCTION public.avoid_multiple_product_order_entries();
DROP FUNCTION public.avoid_duplicate_insert();
DROP FUNCTION public.authenticate(username_input text, password_input text);
DROP FUNCTION public.assign_user_role(target_user_id uuid, new_role text);
DROP FUNCTION public.adjust_product_stock(p_product_id uuid, p_new_quantity integer, p_notes text);
DROP FUNCTION public.add_stylist_holiday(p_stylist_id uuid, p_holiday_date date, p_reason text);
DROP FUNCTION public.add_inventory_transaction(p_product_name text, p_hsn_code text, p_units text, p_change_type text, p_quantity_change numeric, p_current_balance numeric);
DROP FUNCTION public.add_balance_stock_transaction(p_date_time timestamp with time zone, p_product_name text, p_hsn_code text, p_units text, p_change_type text, p_source text, p_reference_id text, p_quantity_change numeric, p_quantity_after_change numeric);
DROP TYPE public.transaction_display;
