...
DROP POLICY IF EXISTS "public select membership_tiers" ON public.membership_tiers;
DROP POLICY IF EXISTS allow_public_select_inventory_salon_consumption ON public.inventory_salon_consumption;
DROP POLICY IF EXISTS "Enable update for authenticated users only" ON public.service_collections;
DROP POLICY IF EXISTS "Enable update for authenticated users" ON public.stylist_holidays;
DROP POLICY IF EXISTS "Enable read access for all users" ON public.stylist_holidays;
DROP POLICY IF EXISTS "Enable read access for all users" ON public.service_collections;
DROP POLICY IF EXISTS "Enable insert for authenticated users only" ON public.service_collections;
DROP POLICY IF EXISTS "Enable insert for authenticated users" ON public.stylist_holidays;
DROP POLICY IF EXISTS "Enable delete for authenticated users only" ON public.service_collections;
DROP POLICY IF EXISTS "Enable delete for authenticated users" ON public.stylist_holidays;
DROP POLICY IF EXISTS "Allow update for authenticated users" ON public.membership_tiers;
DROP POLICY IF EXISTS "Allow read access for all authenticated users" ON public.membership_tiers;
DROP POLICY IF EXISTS "Allow public update membership_tiers" ON public.membership_tiers;
DROP POLICY IF EXISTS "Allow public delete membership_tiers" ON public.membership_tiers;
DROP POLICY IF EXISTS "Allow insert for authenticated users" ON public.membership_tiers;
DROP POLICY IF EXISTS "Allow full access" ON public.stock_history;
DROP POLICY IF EXISTS "Allow delete for authenticated users" ON public.membership_tiers;
DROP POLICY IF EXISTS "Allow authenticated users full access" ON public.inventory_salon_consumption;
DROP POLICY IF EXISTS "Allow all inserts to sales" ON public.sales;
ALTER TABLE IF EXISTS ONLY public.stylist_holidays DROP CONSTRAINT IF EXISTS stylist_holidays_stylist_id_fkey;
ALTER TABLE IF EXISTS ONLY public.stylist_breaks DROP CONSTRAINT IF EXISTS stylist_breaks_stylist_id_fkey;
ALTER TABLE IF EXISTS ONLY public.services DROP CONSTRAINT IF EXISTS services_subcollection_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_subcollections DROP CONSTRAINT IF EXISTS service_subcollections_collection_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sales DROP CONSTRAINT IF EXISTS sales_stylist_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.purchase_stock DROP CONSTRAINT IF EXISTS purchase_stock_stock_id_fkey;
ALTER TABLE IF EXISTS ONLY public.product_stock_transactions DROP CONSTRAINT IF EXISTS product_stock_transactions_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.product_stock_transactions DROP CONSTRAINT IF EXISTS product_stock_transactions_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.product_stock_transactions DROP CONSTRAINT IF EXISTS product_stock_transactions_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.pos_order_items DROP CONSTRAINT IF EXISTS pos_order_items_pos_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.order_stylists DROP CONSTRAINT IF EXISTS order_stylists_stylist_id_fkey;
ALTER TABLE IF EXISTS ONLY public.order_stylists DROP CONSTRAINT IF EXISTS order_stylists_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_logs DROP CONSTRAINT IF EXISTS notification_logs_old_appointment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_logs DROP CONSTRAINT IF EXISTS notification_logs_appointment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.members DROP CONSTRAINT IF EXISTS members_tier_id_fkey;
ALTER TABLE IF EXISTS ONLY public.members DROP CONSTRAINT IF EXISTS members_client_id_fkey;
ALTER TABLE IF EXISTS ONLY public.loyalty_points DROP CONSTRAINT IF EXISTS loyalty_points_client_id_fkey;
ALTER TABLE IF EXISTS ONLY public.services DROP CONSTRAINT IF EXISTS fk_service_collection;
ALTER TABLE IF EXISTS ONLY public.inventory_salon_consumption DROP CONSTRAINT IF EXISTS fk_salon_consumption_product_master;
ALTER TABLE IF EXISTS ONLY public.sales DROP CONSTRAINT IF EXISTS fk_sales_consumption;
ALTER TABLE IF EXISTS ONLY public.inventory_purchases DROP CONSTRAINT IF EXISTS fk_product_master;
ALTER TABLE IF EXISTS ONLY public.product_master DROP CONSTRAINT IF EXISTS fk_product_collection;
ALTER TABLE IF EXISTS ONLY public.consumption DROP CONSTRAINT IF EXISTS fk_consumption_sale;
ALTER TABLE IF EXISTS ONLY public.consumption DROP CONSTRAINT IF EXISTS consumption_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.breaks DROP CONSTRAINT IF EXISTS breaks_stylist_id_fkey;
ALTER TABLE IF EXISTS ONLY public.balance_stock DROP CONSTRAINT IF EXISTS balance_stock_stock_id_fkey;
ALTER TABLE IF EXISTS ONLY public.appointments DROP CONSTRAINT IF EXISTS appointments_stylist_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.appointment_stylists DROP CONSTRAINT IF EXISTS appointment_stylists_stylist_id_fkey;
ALTER TABLE IF EXISTS ONLY public.appointment_stylists DROP CONSTRAINT IF EXISTS appointment_stylists_client_id_fkey;
ALTER TABLE IF EXISTS ONLY public.appointment_stylists DROP CONSTRAINT IF EXISTS appointment_stylists_appointment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.appointment_services DROP CONSTRAINT IF EXISTS appointment_services_stylist_id_fkey;
ALTER TABLE IF EXISTS ONLY public.appointment_services DROP CONSTRAINT IF EXISTS appointment_services_service_id_fkey;
ALTER TABLE IF EXISTS ONLY public.appointment_services DROP CONSTRAINT IF EXISTS appointment_services_client_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.appointment_clients DROP CONSTRAINT IF EXISTS appointment_clients_client_id_fkey;
ALTER TABLE IF EXISTS ONLY public.appointment_clients DROP CONSTRAINT IF EXISTS appointment_clients_appointment_id_fkey;
DROP TRIGGER IF EXISTS update_notification_logs_timestamp ON public.notification_logs;
DROP TRIGGER IF EXISTS trig_avoid_multiple_product_order_entries ON public.product_stock_transactions;
DROP TRIGGER IF EXISTS trig_avoid_duplicate_insert ON public.product_stock_transactions;
DROP TRIGGER IF EXISTS trg_update_stock_on_purchase ON public.purchases;
DROP TRIGGER IF EXISTS trg_update_purchase_cost_on_product_master ON public.purchase_history_with_stock;
DROP TRIGGER IF EXISTS trg_update_product_stock_on_sale ON public.sales;
DROP TRIGGER IF EXISTS trg_update_balance_stock_on_purchase ON public.purchase_stock;
...
DROP TRIGGER IF EXISTS trg_reduce_stock_after_purchase_delete ON public.purchase_history_with_stock;
DROP TRIGGER IF EXISTS trg_purchases_update_stock ON public.purchases;
DROP TRIGGER IF EXISTS trg_log_stock_reduction ON public.product_master;
DROP TRIGGER IF EXISTS trg_log_stock_increase ON public.product_master;
DROP TRIGGER IF EXISTS trg_freeze_remaining_stock ON public.sales_product_data;
DROP TRIGGER IF EXISTS trg_delete_purchase_history ON public.product_master;
DROP TRIGGER IF EXISTS trg_consumption_update_stock ON public.consumption;
DROP TRIGGER IF EXISTS set_timestamp_membership_tiers ON public.membership_tiers;
...
DROP TRIGGER IF EXISTS record_stock_on_product_insert_trigger ON public.product_master;
DROP TRIGGER IF EXISTS purchases_stock_update ON public.purchases;
DROP TRIGGER IF EXISTS process_pos_order_with_duplicates_trigger ON public.pos_orders;
DROP TRIGGER IF EXISTS new_inventory_trigger ON public.balance_stock_data;
DROP TRIGGER IF EXISTS inventory_change_trigger ON public.balance_stock_data;
DROP TRIGGER IF EXISTS after_sales_insert ON public.sales;
DROP TRIGGER IF EXISTS after_purchase_insert ON public.purchases;
DROP TRIGGER IF EXISTS after_insert_stock_transaction ON public.product_stock_transactions;
DROP TRIGGER IF EXISTS after_balance_stock_update ON public.balance_stock;
DROP INDEX IF EXISTS public.idx_unique_duplicate_key;
DROP INDEX IF EXISTS public.idx_stylist_holidays_stylist_id;
DROP INDEX IF EXISTS public.idx_stylist_holidays_date;
DROP INDEX IF EXISTS public.idx_stylist_breaks_stylist_id;
DROP INDEX IF EXISTS public.idx_stylist_breaks_start_time;
DROP INDEX IF EXISTS public.idx_stock_snapshots_product_id;
DROP INDEX IF EXISTS public.idx_stock_snapshots_order_type;
DROP INDEX IF EXISTS public.idx_stock_snapshots_order_date;
DROP INDEX IF EXISTS public.idx_stock_reductions_reference_id;
DROP INDEX IF EXISTS public.idx_stock_reductions_product_name;
DROP INDEX IF EXISTS public.idx_stock_reductions_date;
DROP INDEX IF EXISTS public.idx_stock_history_source;
DROP INDEX IF EXISTS public.idx_stock_history_product_name;
DROP INDEX IF EXISTS public.idx_stock_history_product_id;
DROP INDEX IF EXISTS public.idx_stock_history_date;
DROP INDEX IF EXISTS public.idx_stock_history_change_type;
DROP INDEX IF EXISTS public.idx_services_category;
DROP INDEX IF EXISTS public.idx_services_active;
DROP INDEX IF EXISTS public.idx_service_subcollections_collection_id;
DROP INDEX IF EXISTS public.idx_service_collections_name;
DROP INDEX IF EXISTS public.idx_sales_stylist_id;
DROP INDEX IF EXISTS public.idx_sales_salon_consumption;
...
DROP INDEX IF EXISTS public.idx_purchase_history_transaction_type;
DROP INDEX IF EXISTS public.idx_products_name;
DROP INDEX IF EXISTS public.idx_products_active;
DROP INDEX IF EXISTS public.idx_product_stock_transactions_product_id;
DROP INDEX IF EXISTS public.idx_product_stock_transactions_order_id;
DROP INDEX IF EXISTS public.idx_product_stock_transactions_created_at;
DROP INDEX IF EXISTS public.idx_pos_orders_status;
DROP INDEX IF EXISTS public.idx_pos_orders_customer_name;
DROP INDEX IF EXISTS public.idx_pos_orders_created_at;
DROP INDEX IF EXISTS public.idx_pos_orders_client_name;
DROP INDEX IF EXISTS public.idx_pos_order_items_order_id;
...
DROP INDEX IF EXISTS public.idx_members_tier_id;
DROP INDEX IF EXISTS public.idx_members_expiry;
DROP INDEX IF EXISTS public.idx_members_client_id;
DROP INDEX IF EXISTS public.idx_inventory_purchases_transaction_type;
DROP INDEX IF EXISTS public.idx_duplicate_protection;
DROP INDEX IF EXISTS public.idx_consumption_product_id;
DROP INDEX IF EXISTS public.idx_breaks_stylist_id;
DROP INDEX IF EXISTS public.idx_breaks_start_time;
DROP INDEX IF EXISTS public.idx_balance_stock_history_product;
DROP INDEX IF EXISTS public.idx_balance_stock_history_date;
DROP INDEX IF EXISTS public.idx_balance_stock_data_product_name;
DROP INDEX IF EXISTS public.idx_appointments_stylist_id;
DROP INDEX IF EXISTS public.idx_appointments_status;
DROP INDEX IF EXISTS public.idx_appointments_start_time;
DROP INDEX IF EXISTS public.idx_appointments_reminder_2h;
DROP INDEX IF EXISTS public.idx_appointments_reminder_24h;
DROP INDEX IF EXISTS public.idx_appointments_reminder;
DROP INDEX IF EXISTS public.idx_appointments_paid;
DROP INDEX IF EXISTS public.idx_appointments_client_id;
DROP INDEX IF EXISTS public.idx_appointments_checked_in;
DROP INDEX IF EXISTS public.idx_appointment_stylists_stylist_id;
DROP INDEX IF EXISTS public.idx_appointment_stylists_is_primary;
DROP INDEX IF EXISTS public.idx_appointment_stylists_appointment_id;
DROP INDEX IF EXISTS public.idx_appointment_clients_client_id;
DROP INDEX IF EXISTS public.idx_appointment_clients_appointment_id;
ALTER TABLE IF EXISTS ONLY public.trigger_debug_log DROP CONSTRAINT IF EXISTS trigger_debug_log_pkey;
ALTER TABLE IF EXISTS ONLY public.stylists DROP CONSTRAINT IF EXISTS stylists_pkey;
ALTER TABLE IF EXISTS ONLY public.stylist_holidays DROP CONSTRAINT IF EXISTS stylist_holidays_pkey;
ALTER TABLE IF EXISTS ONLY public.stylist_breaks DROP CONSTRAINT IF EXISTS stylist_breaks_pkey;
ALTER TABLE IF EXISTS ONLY public.stock_snapshots DROP CONSTRAINT IF EXISTS stock_snapshots_sale_order_id_product_id_key;
ALTER TABLE IF EXISTS ONLY public.stock_snapshots DROP CONSTRAINT IF EXISTS stock_snapshots_pkey;
ALTER TABLE IF EXISTS ONLY public.stock_reductions DROP CONSTRAINT IF EXISTS stock_reductions_pkey;
ALTER TABLE IF EXISTS ONLY public.stock_history DROP CONSTRAINT IF EXISTS stock_history_pkey;
ALTER TABLE IF EXISTS ONLY public.stock_details DROP CONSTRAINT IF EXISTS stock_details_pkey;
ALTER TABLE IF EXISTS ONLY public.stock_deduction_debug_log DROP CONSTRAINT IF EXISTS stock_deduction_debug_log_pkey;
ALTER TABLE IF EXISTS ONLY public.services DROP CONSTRAINT IF EXISTS services_pkey;
ALTER TABLE IF EXISTS ONLY public.service_subcollections DROP CONSTRAINT IF EXISTS service_subcollections_pkey;
ALTER TABLE IF EXISTS ONLY public.service_collections DROP CONSTRAINT IF EXISTS service_collections_pkey;
ALTER TABLE IF EXISTS ONLY public.sales_product_table DROP CONSTRAINT IF EXISTS sales_product_table_pkey;
ALTER TABLE IF EXISTS ONLY public.sales_product_new_table DROP CONSTRAINT IF EXISTS sales_product_new_table_pkey;
ALTER TABLE IF EXISTS ONLY public.sales_product_data DROP CONSTRAINT IF EXISTS sales_product_data_pkey;
...
ALTER TABLE IF EXISTS ONLY public.purchase_stock DROP CONSTRAINT IF EXISTS purchase_stock_purchase_invoice_no_key;
ALTER TABLE IF EXISTS ONLY public.purchase_stock DROP CONSTRAINT IF EXISTS purchase_stock_pkey;
ALTER TABLE IF EXISTS ONLY public.purchase_history_with_stock DROP CONSTRAINT IF EXISTS purchase_history_with_stock_pkey;
ALTER TABLE IF EXISTS ONLY public.product_master DROP CONSTRAINT IF EXISTS products_pkey;
ALTER TABLE IF EXISTS ONLY public.product_stock_transactions DROP CONSTRAINT IF EXISTS product_stock_transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.product_stock_transactions DROP CONSTRAINT IF EXISTS product_stock_transactions_duplicate_protection_key_key;
ALTER TABLE IF EXISTS ONLY public.product_collections DROP CONSTRAINT IF EXISTS product_collections_pkey;
ALTER TABLE IF EXISTS ONLY public.pos_orders DROP CONSTRAINT IF EXISTS pos_orders_pkey;
ALTER TABLE IF EXISTS ONLY public.pos_order_items DROP CONSTRAINT IF EXISTS pos_order_items_pkey;
ALTER TABLE IF EXISTS ONLY public.order_stylists DROP CONSTRAINT IF EXISTS order_stylists_pkey;
...
ALTER TABLE IF EXISTS ONLY public.membership_tiers DROP CONSTRAINT IF EXISTS membership_tiers_pkey;
ALTER TABLE IF EXISTS ONLY public.members DROP CONSTRAINT IF EXISTS members_pkey;
ALTER TABLE IF EXISTS ONLY public.loyalty_points DROP CONSTRAINT IF EXISTS loyalty_points_pkey;
ALTER TABLE IF EXISTS ONLY public.inventory_transactions DROP CONSTRAINT IF EXISTS inventory_transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.inventory_salon_consumption DROP CONSTRAINT IF EXISTS inventory_salon_consumption_pkey;
ALTER TABLE IF EXISTS ONLY public.inventory_sales_new DROP CONSTRAINT IF EXISTS inventory_sales_new_pkey;
ALTER TABLE IF EXISTS ONLY public.inventory_purchases DROP CONSTRAINT IF EXISTS inventory_purchases_pkey;
ALTER TABLE IF EXISTS ONLY public.inventory_consumption DROP CONSTRAINT IF EXISTS inventory_consumption_pkey;
ALTER TABLE IF EXISTS ONLY public.expired_products DROP CONSTRAINT IF EXISTS expired_products_pkey;
ALTER TABLE IF EXISTS ONLY public.customers DROP CONSTRAINT IF EXISTS customers_pkey;
ALTER TABLE IF EXISTS ONLY public.consumption DROP CONSTRAINT IF EXISTS consumption_pkey;
ALTER TABLE IF EXISTS ONLY public.clients DROP CONSTRAINT IF EXISTS clients_pkey;
ALTER TABLE IF EXISTS ONLY public.breaks DROP CONSTRAINT IF EXISTS breaks_pkey;
ALTER TABLE IF EXISTS ONLY public.balance_stock_transactions DROP CONSTRAINT IF EXISTS balance_stock_transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.balance_stock DROP CONSTRAINT IF EXISTS balance_stock_stock_id_key;
ALTER TABLE IF EXISTS ONLY public.balance_stock DROP CONSTRAINT IF EXISTS balance_stock_pkey;
ALTER TABLE IF EXISTS ONLY public.balance_stock_history DROP CONSTRAINT IF EXISTS balance_stock_history_pkey;
ALTER TABLE IF EXISTS ONLY public.balance_stock_data DROP CONSTRAINT IF EXISTS balance_stock_data_pkey;
ALTER TABLE IF EXISTS ONLY public.auth DROP CONSTRAINT IF EXISTS auth_username_key;
ALTER TABLE IF EXISTS ONLY public.auth DROP CONSTRAINT IF EXISTS auth_pkey;
ALTER TABLE IF EXISTS ONLY public.appointments DROP CONSTRAINT IF EXISTS appointments_pkey;
ALTER TABLE IF EXISTS ONLY public.appointment_stylists DROP CONSTRAINT IF EXISTS appointment_stylists_pkey;
ALTER TABLE IF EXISTS ONLY public.appointment_stylists DROP CONSTRAINT IF EXISTS appointment_stylists_appointment_id_stylist_id_key;
ALTER TABLE IF EXISTS ONLY public.appointment_services DROP CONSTRAINT IF EXISTS appointment_services_pkey;
ALTER TABLE IF EXISTS ONLY public.appointment_services DROP CONSTRAINT IF EXISTS appointment_services_id_key;
ALTER TABLE IF EXISTS ONLY public.appointment_clients DROP CONSTRAINT IF EXISTS appointment_clients_pkey;
...
ALTER TABLE IF EXISTS public.trigger_debug_log ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.stock_details ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.stock_deduction_debug_log ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.purchase_stock ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.migrations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.balance_stock ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.admin_users ALTER COLUMN id DROP DEFAULT;
DROP VIEW IF EXISTS public.vw_stock_transactions;
DROP VIEW IF EXISTS public.vw_purchase_recalc;
DROP SEQUENCE IF EXISTS public.trigger_debug_log_id_seq;
DROP TABLE IF EXISTS public.trigger_debug_log;
DROP TABLE IF EXISTS public.stylists;
DROP TABLE IF EXISTS public.stylist_holidays;
DROP TABLE IF EXISTS public.stylist_breaks;
DROP TABLE IF EXISTS public.stock_reductions;
DROP VIEW IF EXISTS public.stock_history_view;
DROP TABLE IF EXISTS public.stock_history;
DROP SEQUENCE IF EXISTS public.stock_details_id_seq;
DROP TABLE IF EXISTS public.stock_details;
DROP SEQUENCE IF EXISTS public.stock_deduction_debug_log_id_seq;
DROP TABLE IF EXISTS public.stock_deduction_debug_log;
DROP TABLE IF EXISTS public.services;
DROP TABLE IF EXISTS public.service_subcollections;
DROP TABLE IF EXISTS public.service_collections;
DROP VIEW IF EXISTS public.salon_stock_tracking;
DROP VIEW IF EXISTS public.salon_consumption_view;
DROP VIEW IF EXISTS public.salon_consumption_stock_views;
DROP VIEW IF EXISTS public.salon_consumption_stock_viewh;
DROP VIEW IF EXISTS public.salon_consumption_products;
DROP VIEW IF EXISTS public.salon_consumption_new;
DROP VIEW IF EXISTS public.salon_consumption_history;
DROP VIEW IF EXISTS public.salon_consumption_final;
DROP TABLE IF EXISTS public.sales_product_table;
DROP VIEW IF EXISTS public.sales_product_stock_view;
DROP TABLE IF EXISTS public.sales_product_new_table;
DROP VIEW IF EXISTS public.sales_product_new_final_s;
DROP VIEW IF EXISTS public.sales_product_new;
DROP TABLE IF EXISTS public.stock_snapshots;
DROP TABLE IF EXISTS public.sales_product_data;
DROP VIEW IF EXISTS public.sales_history_grouped;
DROP VIEW IF EXISTS public.sales_history_fl;
DROP VIEW IF EXISTS public.sales_history_final_test3;
DROP VIEW IF EXISTS public.sales_history_final_test2;
DROP VIEW IF EXISTS public.sales_history_final_test;
DROP VIEW IF EXISTS public.sales_history_final_tes;
DROP VIEW IF EXISTS public.sales_history_final_new_final;
DROP VIEW IF EXISTS public.sales_history_final_2;
DROP VIEW IF EXISTS public.sales_history_final;
DROP VIEW IF EXISTS public.sales_history_fin;
DROP VIEW IF EXISTS public.sale_stock_view_new;
DROP VIEW IF EXISTS public.sale_stock_view;
DROP VIEW IF EXISTS public.sale_product_vieww;
DROP SEQUENCE IF EXISTS public.purchase_stock_id_seq;
DROP TABLE IF EXISTS public.purchase_stock;
...
DROP VIEW IF EXISTS public.pos_product_sales_with_stoc;
DROP TABLE IF EXISTS public.pos_order_items;
DROP TABLE IF EXISTS public.order_stylists;
...
DROP VIEW IF EXISTS public.inventory_transaction_view;
DROP VIEW IF EXISTS public.inventory_transaction_history;
DROP TABLE IF EXISTS public.inventory_transactions;
DROP TABLE IF EXISTS public.inventory_salon_consumption;
DROP TABLE IF EXISTS public.inventory_sales_new;
DROP TABLE IF EXISTS public.inventory_purchases;
DROP TABLE IF EXISTS public.inventory_consumption;
DROP VIEW IF EXISTS public.g;
DROP TABLE IF EXISTS public.expired_products;
...
DROP TABLE IF EXISTS public.balance_stock_transactions;
DROP SEQUENCE IF EXISTS public.balance_stock_id_seq;
DROP TABLE IF EXISTS public.balance_stock_history;
DROP TABLE IF EXISTS public.balance_stock_data;
DROP TABLE IF EXISTS public.balance_stock;
DROP TABLE IF EXISTS public.auth;
DROP TABLE IF EXISTS public.appointments;
DROP TABLE IF EXISTS public.appointment_stylists;
DROP TABLE IF EXISTS public.appointment_services;
DROP TABLE IF EXISTS public.appointment_clients;
DROP SEQUENCE IF EXISTS public.admin_users_id_seq;
DROP FUNCTION IF EXISTS public.verify_stock_recording(product_id uuid);
DROP FUNCTION IF EXISTS public.update_updated_at_column();
DROP FUNCTION IF EXISTS public.update_stylists_on_holiday();
DROP FUNCTION IF EXISTS public.update_stylist_availability_on_holiday_change();
DROP FUNCTION IF EXISTS public.update_stock_transaction_history();
DROP FUNCTION IF EXISTS public.update_stock_on_purchase();
DROP FUNCTION IF EXISTS public.update_sales_history_product_name();
DROP FUNCTION IF EXISTS public.update_product_stock_on_sale();
DROP FUNCTION IF EXISTS public.update_product_stock_after_consumption();
DROP FUNCTION IF EXISTS public.update_product_master_purchase_cost();
DROP FUNCTION IF EXISTS public.update_notification_logs_updated_at();
DROP FUNCTION IF EXISTS public.update_balance_stock_on_purchase();
DROP FUNCTION IF EXISTS public.update_balance_stock_on_orders();
DROP FUNCTION IF EXISTS public.update_balance_stock_data();
DROP FUNCTION IF EXISTS public.update_balance_stock();
DROP FUNCTION IF EXISTS public.trigger_sync_salon_consumption();
DROP FUNCTION IF EXISTS public.trigger_set_timestamp();
DROP FUNCTION IF EXISTS public.sync_total_amounts();
DROP FUNCTION IF EXISTS public.sync_service_prices();
DROP FUNCTION IF EXISTS public.sync_sales_product_table();
DROP FUNCTION IF EXISTS public.sync_product_to_inventory();
DROP FUNCTION IF EXISTS public.sync_pos_salon_consumption();
DROP FUNCTION IF EXISTS public.sync_customer_names();
DROP FUNCTION IF EXISTS public.sales_product_new_update();
DROP FUNCTION IF EXISTS public.sales_product_new_instead_of_update();
DROP FUNCTION IF EXISTS public.sales_product_new_insert();
DROP FUNCTION IF EXISTS public.sales_product_new_delete();
DROP FUNCTION IF EXISTS public.safe_create_order(order_data jsonb);
DROP FUNCTION IF EXISTS public.restore_stock_on_order_item_delete();
DROP FUNCTION IF EXISTS public.restore_pos_orders();
DROP FUNCTION IF EXISTS public.reset_stylists_not_on_holiday();
DROP FUNCTION IF EXISTS public.remove_stylist_holiday(p_holiday_id uuid);
DROP FUNCTION IF EXISTS public.reduce_stock_on_purchase_delete();
DROP FUNCTION IF EXISTS public.reduce_balance_stock_on_order();
DROP FUNCTION IF EXISTS public.record_stock_transactions_after_order();
DROP FUNCTION IF EXISTS public.record_purchase_stock_change();
DROP FUNCTION IF EXISTS public.record_product_stock_transaction();
DROP FUNCTION IF EXISTS public.record_product_stock_on_insert();
DROP FUNCTION IF EXISTS public.record_pos_order_stock_change_debug();
DROP FUNCTION IF EXISTS public.record_pos_order_stock_change();
DROP FUNCTION IF EXISTS public.record_order_item_stock_change();
DROP FUNCTION IF EXISTS public.record_inventory_transaction(p_product_name text, p_hsn_code text, p_units text, p_change_type text, p_quantity_change numeric, p_current_balance numeric, p_source text, p_reference_id text);
DROP FUNCTION IF EXISTS public.process_pos_order_with_duplicates();
DROP FUNCTION IF EXISTS public.prevent_remaining_stock_update();
DROP FUNCTION IF EXISTS public.order_has_products(order_data jsonb);
DROP FUNCTION IF EXISTS public.monitor_product_stock_transaction();
DROP FUNCTION IF EXISTS public.log_stock_reduction();
DROP FUNCTION IF EXISTS public.log_stock_increase();
DROP FUNCTION IF EXISTS public.log_stock_change_from_product_master();
DROP FUNCTION IF EXISTS public.log_sales_reduction();
DROP FUNCTION IF EXISTS public.log_remaining_stock_changes();
DROP FUNCTION IF EXISTS public.log_purchase_addition();
DROP FUNCTION IF EXISTS public.log_new_inventory();
DROP FUNCTION IF EXISTS public.log_inventory_change();
DROP FUNCTION IF EXISTS public.log_balance_stock_reduction();
DROP FUNCTION IF EXISTS public.is_stylist_on_holiday(p_stylist_id uuid, p_date date);
DROP FUNCTION IF EXISTS public.insert_stock_snapshot();
DROP FUNCTION IF EXISTS public.insert_salon_consumption_snapshot();
DROP FUNCTION IF EXISTS public.insert_sales_product_data(p_serial_no text, p_order_id uuid, p_date date, p_product_name text, p_quantity integer, p_unit_price_ex_gst numeric, p_gst_percentage numeric, p_discount numeric, p_tax numeric, p_hsn_code text, p_product_type text, p_mrp_incl_gst numeric, p_discounted_sales_rate_ex_gst numeric, p_current_stock integer, p_total_sold integer);
DROP FUNCTION IF EXISTS public.increment_product_stock(p_product_id uuid, p_increment_quantity integer);
DROP FUNCTION IF EXISTS public.increment_product_stock(product_updates jsonb[]);
DROP FUNCTION IF EXISTS public.handle_updated_at();
DROP FUNCTION IF EXISTS public.handle_order_deletion_update_client_spent();
DROP FUNCTION IF EXISTS public.handle_new_user();
DROP FUNCTION IF EXISTS public.get_transaction_display();
DROP FUNCTION IF EXISTS public.get_table_columns(table_name text);
DROP FUNCTION IF EXISTS public.get_stylist_holidays(p_stylist_id uuid);
DROP FUNCTION IF EXISTS public.get_stock_transactions(p_limit integer, p_offset integer, p_date_from timestamp with time zone, p_date_to timestamp with time zone, p_product_id uuid, p_transaction_type character varying);
DROP FUNCTION IF EXISTS public.get_product_transaction_history(p_product_id uuid);
DROP FUNCTION IF EXISTS public.get_next_balance_stock_serial();
DROP FUNCTION IF EXISTS public.get_balance_stock();
DROP VIEW IF EXISTS public.product_stock_transaction_history;
DROP TABLE IF EXISTS public.product_stock_transactions;
DROP TABLE IF EXISTS public.product_master;
DROP TABLE IF EXISTS public.pos_orders;
DROP FUNCTION IF EXISTS public.generate_salon_consumption_serial();
DROP FUNCTION IF EXISTS public.freeze_remaining_stock_on_update();
DROP FUNCTION IF EXISTS public.fn_insert_purchase_history_stock();
DROP FUNCTION IF EXISTS public.exec_sql(sql text);
DROP FUNCTION IF EXISTS public.ensure_inventory_sales_product_name();
DROP FUNCTION IF EXISTS public.delete_sales_item(item_id text);
DROP FUNCTION IF EXISTS public.delete_purchase_history_on_product_delete();
DROP FUNCTION IF EXISTS public.decrement_product_stock_compat(product_updates jsonb);
DROP FUNCTION IF EXISTS public.decrement_product_stock(product_updates jsonb[]);
DROP FUNCTION IF EXISTS public.create_stylist_holidays_table();
DROP FUNCTION IF EXISTS public.clean_duplicate_transactions();
DROP FUNCTION IF EXISTS public.check_debug_logs(order_id text);
DROP FUNCTION IF EXISTS public.check_appointment_conflict();
DROP FUNCTION IF EXISTS public.check_admin_login(email_input text, password_input text);
DROP TABLE IF EXISTS public.admin_users;
DROP FUNCTION IF EXISTS public.avoid_multiple_product_order_entries();
DROP FUNCTION IF EXISTS public.avoid_duplicate_insert();
DROP FUNCTION IF EXISTS public.authenticate(username_input text, password_input text);
DROP FUNCTION IF EXISTS public.assign_user_role(target_user_id uuid, new_role text);
DROP FUNCTION IF EXISTS public.adjust_product_stock(p_product_id uuid, p_new_quantity integer, p_notes text);
DROP FUNCTION IF EXISTS public.add_stylist_holiday(p_stylist_id uuid, p_holiday_date date, p_reason text);
DROP FUNCTION IF EXISTS public.add_inventory_transaction(p_product_name text, p_hsn_code text, p_units text, p_change_type text, p_quantity_change numeric, p_current_balance numeric);
DROP FUNCTION IF EXISTS public.add_balance_stock_transaction(p_date_time timestamp with time zone, p_product_name text, p_hsn_code text, p_units text, p_change_type text, p_source text, p_reference_id text, p_quantity_change numeric, p_quantity_after_change numeric);
DROP TYPE IF EXISTS public.transaction_display;
