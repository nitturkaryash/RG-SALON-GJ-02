...
export const migrateCollectionServicesToMainTable = async (): Promise<{
  ...
  try {
    console.log(
      'Starting migration of collection services to main services table'
    );
    ...
    console.log(
      `Found ${collectionServices.length} collection services to migrate`
    );
...
export const syncMainServicesToCollections = async (): Promise<{
  ...
  try {
    console.log(
      'Starting sync of main services to collections based on category'
    );
    ...
    const servicesWithCategory = mainServices.filter(
      service => service.category && service.category.trim() !== ''
    );
    ...
    console.log(
      `Found ${servicesWithCategory.length} services with valid categories`
    );
