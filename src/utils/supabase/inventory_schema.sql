...
CREATE INDEX IF NOT EXISTS idx_consumption_order_id ON inventory_consumption(order_id);
CREATE INDEX IF NOT EXISTS idx_consumption_date ON inventory_consumption(date);
