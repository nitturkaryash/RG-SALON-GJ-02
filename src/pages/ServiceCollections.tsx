...
export default function ServiceCollections() {
  ...
  const handleDelete = (id: string) => {
    if (
      window.confirm(
        'Are you sure you want to delete this collection? All services in this collection will also be deleted.'
      )
    ) {
      ...
      {serviceCollections?.length ? (
        ...
        <Paper sx={{ p: 3, textAlign: 'center' }}>
          <Typography variant='body1' color='text.secondary'>
            No service collections found. Click "Add Collection" to create your
            first one.
          </Typography>
        </Paper>
      )}
