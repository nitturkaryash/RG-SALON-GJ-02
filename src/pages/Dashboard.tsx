...
export default function Dashboard() {
  ...
  const topServicesData = analyticsSummary
    ? {
        labels: analyticsSummary.topServices.map(
  ...
  const paymentMethodData = analyticsSummary
    ? {
        labels: analyticsSummary.paymentMethodBreakdown.map(
          payment =>
        ...
        datasets: [
          {
            ...
            data: analyticsSummary.paymentMethodBreakdown.map(
  ...
  const customerBehaviorData = analyticsSummary
    ? {
        labels:
          analyticsSummary.customerBehavior.visitFrequencyDistribution.map(
            item => item.range
          ),
        datasets: [
          {
            label: 'Customer Count',
            data: analyticsSummary.customerBehavior.visitFrequencyDistribution.map(
  ...
  const staffPerformanceData = analyticsSummary
    ? {
        labels: analyticsSummary.staffPerformance.topPerformers.map(
          staff => staff.stylistName
        ),
        datasets: [
          {
            label: 'Revenue',
            data: analyticsSummary.staffPerformance.topPerformers.map(
              staff => staff.revenue
            ),
            backgroundColor: 'rgba(107, 142, 35, 0.7)',
            borderColor: '#6B8E23',
  ...
  const serviceCategoriesData = analyticsSummary
    ? {
        labels: analyticsSummary.serviceCategoryBreakdown.map(
          category => category.category
        ),
        datasets: [
          {
            label: 'Revenue by Category',
            data: analyticsSummary.serviceCategoryBreakdown.map(
  ...
  const appointmentStatusData = analyticsSummary
    ? {
        labels: analyticsSummary.appointmentStatusBreakdown.map(
          status =>
        ...
        datasets: [
          {
            ...
            data: analyticsSummary.appointmentStatusBreakdown.map(
              status => status.count
            ),
            backgroundColor: [
              '#6B8E23', // Completed
      ...
      <Box sx={{ flex: 1, overflow: 'auto', p: 2 }}>
        <Grid container spacing={2}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            <Tooltip
              title={
                isGlobalFullscreen
                  ? 'Exit Fullscreen (Ctrl+Alt+A)'
                  : 'Fullscreen Mode (Ctrl+Alt+A)'
              }
            >
              <IconButton
        ...
        {isLoading && !analyticsSummary ? (
          ...
          <Box width='100%' px={2}>
            ...
            >
              Failed to load analytics data. Please try refreshing the
              dashboard.
            </Alert>
          </Box>
        ) : (
          <Fade in={!!analyticsSummary}>
            <Box width='100%'>
                    ...
                    {settings.visibleMetrics.dailySales && (
                      <Grid item xs={12} md={3}>
                        <KPICard
                          ...
                          trend={
                            analyticsSummary.salesChangePercentage >= 0
                              ? 'up'
                              : 'down'
                          }
                        />
                    ...
                    {settings.visibleMetrics.averageTicket && (
                      <Grid item xs={12} md={3}>
                        <KPICard
                          ...
                          value={formatAmount(
                            analyticsSummary.averageTicketPrice
                          )}
                          icon={<ReceiptIcon />}
                          color='warning'
                          ...
                          trend={
                            analyticsSummary.averageTicketChangePercentage >= 0
                              ? 'up'
                              : 'down'
                          }
                        />
                    ...
                    {settings.visibleMetrics.revenueBreakdown && (
                      <Grid item xs={12}>
                        <CardWrapper>
                          ...
                          >
                            {renderChart(
                              settings.chartTypes.salesTrend,
                              salesTrendData
                            )}
                          </DownloadableCard>
                        </CardWrapper>
                            ...
                            data={[
                              {
                                category: 'Services',
                                amount:
                                  analyticsSummary.revenueAnalytics
                                    .serviceRevenue,
                              },
                              {
                                category: 'Products',
                          ...
                          >
                            ...
                            >
                              <OrdersVsProductsChart
                                ...
                                serviceCount={
                                  analyticsSummary.appointmentAnalytics
                                    .totalAppointments
                                }
                                productCount={
                              ...
                              <Box textAlign='center' mb={2}>
                                <Grid container spacing={2}>
                                  <Grid item xs={4}>
                                    ...
                                    >
                                      {analyticsSummary.staffPerformance
                                        .totalStaff || 0}
                                    </Typography>
                                    <Typography
                                      variant='caption'
                                    ...
                                    >
                                      {(() => {
                                        ...
                                        const highPerformers =
                                          analyticsSummary.staffPerformance.topPerformers.filter(
                                            staff =>
                                              staff.revenue >= avgRevenue * 1.2
                                          ).length;
                                        const totalStaff =
                                          analyticsSummary.staffPerformance
                                            .totalStaff || 1;
                                        return Math.round(
                                          (highPerformers / totalStaff) * 100
                                        );
                                      })()}
                                      %
                                    </Typography>
                                  ...
                                  {analyticsSummary.staffPerformance
                                    ...
                                    analyticsSummary.staffPerformance.topPerformers
                                      ...
                                      .map((staff, index) => {
                                        ...
                                        const performancePercentage = Math.min(
                                          (staff.revenue /
                                            Math.max(averageRevenue, 1)) *
                                            100,
                                          150
                                        );
                                        const isHighPerformer =
                                          staff.revenue >= averageRevenue * 1.2;
                                        ...
                                        return (
                                          <Box
                                            ...
                                            sx={{
                                              ...
                                              borderRadius: 2,
                                              border: '1px solid',
                                              borderColor: isHighPerformer
                                                ? 'success.light'
                                                : 'divider',
                                              backgroundColor: isHighPerformer
                                                ? 'success.lighter'
                                                : 'background.paper',
                                            }}
                                          >
                                            ...
                                            >
                                              ...
                                              >
                                                {staff.efficiency
                                                  ? `${staff.efficiency.toFixed(1)}% efficient`
                                                  : 'Calculating...'}
                                              </Typography>
                                            </Box>
                                          </Box>
                                    ...
                                    >
                                      ...
                                      <Typography variant='caption'>
                                        Data will appear once appointments are
                                        completed
                                      </Typography>
                                    </Box>
                                  )}
              ...
              {(settings.visibleMetrics.customerBehavior ||
                ...
                <Grid container spacing={3} mb={4}>
                  ...
                  >
                      ...
                      <Grid item xs={12} md={6}>
                        <CardWrapper>
                          <DownloadableCard
                            ...
                            data={
                              analyticsSummary.customerBehavior.topCustomers
                            }
                          ...
                          >
                              ...
                              <Grid item xs={6}>
                                <Box textAlign='center'>
                                  <Typography variant='h4' color='success.main'>
                                    {
                                      analyticsSummary.customerBehavior
                                        .newCustomers
                                    }
                                  </Typography>
                                  <Typography
                            ...
                            {renderChart(
                              settings.chartTypes.customerBehavior,
                          ...
                          >
                            <Box textAlign='center' mb={2}>
                              <Typography variant='h3' color='primary.main'>
                                {analyticsSummary.customerBehavior.customerRetentionRate.toFixed(
                                  1
                                )}
                                %
                              </Typography>
                            ...
                            {renderChart(
                              settings.chartTypes.customerRetention,
                              {
                                labels: [
                                  'Returning Customers',
                                  'New Customers',
                    ...
                    {settings.visibleMetrics.upcomingAppointments &&
                      analyticsSummary.upcomingAppointments.length > 0 && (
                        <Grid item xs={12}>
                          <CardWrapper>
                            <DownloadableCard
                            ...
                            >
                              ...
                              >
                                <List sx={{ p: 0 }}>
                                  {analyticsSummary.upcomingAppointments
                                    .slice(0, 10)
                                ...
                                {analyticsSummary.upcomingAppointments.length >
                                  10 && (
                                  <Box
                                    sx={{
                                      textAlign: 'center',
              ...
              {settings.visibleMetrics.paymentMethods && (
                <Grid container spacing={3} mb={4}>
                  ...
                  >
                      ...
                      <CardWrapper>
                        ...
                        >
                          <Box textAlign='center' mb={2}>
                            ...
                            >
                              {formatCurrency(
                                analyticsSummary.paymentMethodBreakdown.reduce(
                                  (sum, p) => sum + p.amount,
                                  0
                                )
                              )}
                            ...
                            {analyticsSummary?.paymentMethodBreakdown &&
                              analyticsSummary.paymentMethodBreakdown.length >
                                0 && (
                                <Typography
                                  variant='caption'
                                  color='text.secondary'
                                ...
                                >
                                  ...
                                  {analyticsSummary.paymentMethodBreakdown
                                    ...
                                    .map(
                                      p =>
                                        `${(PAYMENT_METHOD_LABELS[p.paymentMethod] || p.paymentMethod).toLowerCase()} ${Math.round(p.amount)}`
                                    )
                                    .join(' ')}
                                  )
                                </Typography>
                          ...
                          {renderChart(
                            settings.chartTypes.paymentMethods,
                            paymentMethodData,
                            200
                          )}
                        </DownloadableCard>
                    ...
                    {/* SPLIT PAYMENTS - NEW */}
                    {settings.visibleMetrics.splitPayments &&
                      analyticsSummary.splitPaymentDetails.length > 0 && (
                        <Grid item xs={12} md={6}>
                          <CardWrapper>
                            <DownloadableCard
                            ...
                            >
                              <Box sx={{ height: 330, overflowY: 'auto' }}>
                                <List>
                                  {analyticsSummary.splitPaymentDetails
                                    .slice(0, 8)
                                    .map((payment, index) => (
                    ...
                    {settings.visibleMetrics.paymentTrends && (
                      <Grid item xs={12}>
                        <CardWrapper>
                          ...
                          >
                            <Grid container spacing={2}>
                              {analyticsSummary.paymentMethodBreakdown.map(
                                (method, index) => (
                                  <Grid
                                    item
                                    xs={12}
              ...
              {/* MONTHLY COMPARISON */}
              {settings.visibleMetrics.monthlyComparison &&
                analyticsSummary.monthlyComparison.length > 0 && (
                  <Grid container spacing={3} mb={4}>
                    <SectionWrapper
                          ...
                          >
                            <TableContainer>
                              <Table size='small'>
                                ...
                                <TableBody>
                                  {analyticsSummary.monthlyComparison.map(
                                    (comparison, index) => (
                                      <TableRow key={index}>
                                        <TableCell>
                                          {comparison.metric}
                                          ...
                                          >
                                            ...
                                            >
                                              {comparison.changePercentage >= 0
                                                ? '+'
                                                : ''}
                                              {comparison.changePercentage.toFixed(
                                                1
                                              )}
                                              %
                                            </Typography>
