...
import { formatCurrency, formatPercentage } from '../utils/formatting/format';
...
export default function CollectionDetail() {
  ...
  useEffect(() => {
    ...
    const calculatedProfit = calculateProfit(
      formData.mrp_incl_gst,
      formData.gst_percentage
    );
    setProfit(calculatedProfit);

    const calculatedMargin = calculateProfitMargin(
      formData.mrp_incl_gst,
      formData.gst_percentage
    );
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formData.mrp_incl_gst <= 0)
      errors.mrp_incl_gst = 'Price must be greater than 0';
              ...
              return (
                <TableRow key={product.id} hover>
                  ...
                  <TableCell align='right'>
                    {formatCurrency(product.mrp_incl_gst)}
                  </TableCell>
                  <TableCell align='right'>
        ...
        <form onSubmit={handleSubmit}>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                <TextField
                  ...
                  onChange={e =>
                    setFormData({
                      ...formData,
                      mrp_incl_gst: parseFloat(e.target.value) || 0,
                    })
                  }
                  required
                  fullWidth
          ...
          <DialogActions>
            ...
            <Button
              ...
              variant='contained'
              disabled={
                !formData.product_name.trim() || formData.mrp_incl_gst <= 0
              }
            >
