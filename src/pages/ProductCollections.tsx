...
export default function ProductCollections() {
  ...
  const handleDelete = (id: string) => {
    if (
      window.confirm(
        'Are you sure you want to delete this collection? All products in this collection will also be deleted.'
      )
    ) {
      ...
      {productCollections?.length ? (
        ...
        <Paper sx={{ p: 3, textAlign: 'center' }}>
          <Typography variant='body1' color='text.secondary'>
            No product collections found. Click "Add Collection" to create your
            first one.
          </Typography>
        </Paper>
      )}
