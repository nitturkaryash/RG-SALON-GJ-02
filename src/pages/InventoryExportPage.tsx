      ...
      >
        ...
        <Box sx={{ p: 3 }}>
          <Typography variant='body1' paragraph>
            This tool allows you to export all inventory transactions
            (purchases, sales, and salon consumption) to a single Excel file
            with standardized column headers. The export includes detailed
            information about each transaction, making it easy to analyze your
            inventory data or import it into other systems.
          </Typography>
