...
export default function ServiceSubCollections() {
  ...
  const handleDelete = (id: string) => {
    if (
      window.confirm(
        'Are you sure you want to delete this sub-collection? All services within will also be affected.'
      )
    ) {
      ...
      {subCollections.length ? (
        ...
        <Paper sx={{ p: 3, textAlign: 'center' }}>
          <Typography variant='body1' color='text.secondary'>
            No sub-collections found. Click "Add Sub-Collection" to create your
            first one.
          </Typography>
        </Paper>
      )}
