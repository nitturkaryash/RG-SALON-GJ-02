          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-gray-900">{userProfile.salon_name || 'Not set'}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-gray-600">GST Rate</span>
                <span className="text-sm text-gray-900">{userProfile.gst_percentage || '18'}%</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-gray-600">HSN Code</span>
                <span className="text-sm text-gray-900">{userProfile.hsn_code || 'Not set'}</span>
              </div>
              <button
