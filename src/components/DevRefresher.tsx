 ...
 * We're disabling this component entirely to remove the Force Refresh button
 */
export function DevRefresher() {
  // Return null to disable this component completely
  return null;
  
  // Previous implementation is kept but not executed
