...
export default function OrdersVsProductsChart({
  ...
  const servicePercentage = totalRevenue > 0 ? (serviceRevenue / totalRevenue) * 100 : 0;
  const productPercentage = totalRevenue > 0 ? (productRevenue / totalRevenue) * 100 : 0;
      ...
      <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          >
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 0.5 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                ...
                <Typography variant="body2" fontWeight="medium">Services</Typography>
              </Box>
              <Chip 
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 0.5 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                ...
                >
                  {serviceGrowth > 0 ? '+' : ''}{serviceGrowth.toFixed(1)}%
                </Typography>
              </Box>
            </Box>
          </Box>
          ...
          >
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 0.5 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                ...
                <Typography variant="body2" fontWeight="medium">Products</Typography>
              </Box>
              <Chip 
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 1 }}>
          <Typography variant="caption" align="center" color="text.secondary">
            Services {servicePercentage.toFixed(1)}% : {productPercentage.toFixed(1)}% Products
          </Typography>
        </Box>
      </Box>
    </Box>
