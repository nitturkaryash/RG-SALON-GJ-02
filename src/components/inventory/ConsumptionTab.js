...
const ConsumptionTab = ({ consumption = [], isLoading, error }) => {
    ...
    const consumptionData = Array.isArray(consumption) ? consumption : [];
    ...
    const handleSyncData = async () => {
        try {
            console.log('Syncing consumption data with date range:', dateRange);
            
            // Call sync with date parameters
            const result = await syncConsumptionFromPos(dateRange.startDate, dateRange.endDate);
