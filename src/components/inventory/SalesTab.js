  ...
  return _jsxs(Box, {
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsx(Typography, { variant: 'h6', children: 'Sales Records' }),
          _jsx(Button, {
            variant: 'contained',
            color: 'primary',
            startIcon: isSyncingSales
              ? _jsx(CircularProgress, { size: 20, color: 'inherit' })
              : _jsx(SyncIcon, {}),
            onClick: handleOpenSyncDialog,
            disabled: isSyncingSales,
            children: 'Sync with POS',
          }),
        ],
      }),
      isSyncingSales &&
      ...
      error &&
        _jsxs(Alert, {
          severity: 'error',
          sx: { mb: 2 },
          children: ['Error loading sales: ', error.message],
        }),
      isLoading
        ? _jsx(Box, {
            ...
            children:
              sales.length === 0
                ? _jsx(Alert, {
                    severity: 'info',
                    children:
                      'No sales records found. Sync with the POS system to fetch sales data.',
                  })
                : _jsxs(Paper, {
                    children: [
                      _jsx(TableContainer, {
                                  ...
                                  _jsxs(
                                    TableRow,
                                    {
                                      ...
                                      children: [
                                        ...
                                        _jsx(TableCell, {
                                          children: sale.invoice_no,
                                        }),
                                        _jsx(TableCell, {
                                          children: sale.product_name,
                                        }),
                                        _jsx(TableCell, {
                                          children: sale.hsn_code,
                                        }),
                                        _jsx(TableCell, {
                                          children: sale.units,
                                        }),
                                        _jsx(TableCell, {
                                          align: 'right',
                                          children: sale.sales_qty,
                                        }),
                                        _jsxs(TableCell, {
                                          align: 'right',
                                          children: [
                                            '\u20B9',
                                            sale.mrp_incl_gst?.toFixed(2),
                                          ],
                                        }),
                                        _jsxs(TableCell, {
                                          align: 'right',
                                          children: [
                                            sale.discount_on_sales_percentage,
                                            '%',
                                          ],
                                        }),
                                        _jsxs(TableCell, {
                                          ...
                                          children: [
                                            '\u20B9',
                                            sale.discounted_sales_rate_excl_gst?.toFixed(
                                              2
                                            ),
                                          ],
                                        }),
                                        ...
                                        _jsxs(TableCell, {
                                          ...
                                          children: [
                                            '\u20B9',
                                            sale.sales_taxable_value?.toFixed(
                                              2
                                            ),
                                          ],
                                        }),
                                        _jsxs(TableCell, {
                                          ...
                                          children: [
                                            '\u20B9',
                                            sale.invoice_value_rs?.toFixed(2),
                                          ],
                                        }),
                                      ],
                                    },
      ...
      _jsxs(Dialog, {
        ...
        children: [
          _jsx(DialogTitle, { children: 'Sync Sales Data from POS' }),
          _jsxs(DialogContent, {
            children: [
