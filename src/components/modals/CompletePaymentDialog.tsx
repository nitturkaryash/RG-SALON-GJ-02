...
import { Order } from '../../hooks/orders/usePOS';
          ...
          <Grid item xs={12} md={6}>
            ...
            <Paper variant='outlined' sx={{ p: 3 }}>
              <Box sx={{ mb: 3 }}>
                ...
                <FormControl fullWidth margin='normal'>
                  ...
                  <Select
                    ...
                    disabled={isProcessing}
                  >
                    {PAYMENT_METHODS.filter(method => method !== 'bnpl').map(
                      method => (
              ...
              {paymentAmount < order.pending_amount && (
                <Alert severity='warning' sx={{ mb: 2 }}>
                  <Typography variant='body2'>
                    ...
                    {formatCurrency(order.pending_amount - paymentAmount)} will
                    remain as pending.
                  </Typography>
                </Alert>
              )}
              ...
              <Alert severity='info' sx={{ mb: 2 }}>
                <Typography variant='body2'>
                  Completing this payment will update the customer's payment
                  history.
                </Typography>
              </Alert>
            </Paper>
